...
public class HelpRequesterQueue {
  ...
  /**
   * Modifier that sets a HelpRequester as being deescalated by name
   *
   * @param helpRequesterName String name of the HelpRequester to deescalate
